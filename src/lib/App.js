...
class MentorJS {
    ...
    getModelHeaderClose() {
        return `<span class="${this.getModalOption("modalDivHeaderCloseClass")}" id="${this.getModalOption(
            "closeButtonId",
        )}"></span>`;
    }
    getModelTitle() {
    ...
    getModelPreviousButton() {
        return `<button class="${this.getModalOption("previousButtonClass")}">${this.getModalOption(
            "previousButtonText",
        )}</button>`;
    }
    getModelNextButton() {
        return `<button class="${this.getModalOption("nextButtonClass")}">${this.getModalOption(
            "nextButtonText",
        )}</button>`;
    }
    getModelEndButton() {
        return `<button class="${this.getModalOption("endButtonClass")}">${this.getModalOption(
            "endButtonText",
        )}</button>`;
    }
    getModelFooter() {
    ...
    openModal() {
        ...
        this.insertElementAfter(
            ...
            "div",
            this.getModalOption("backgroundEffectClass"),
        );
        ...
        [].forEach.call(
            document.getElementsByClassName(this.getModalOption("targetToggleClass")),
            function (el) {
    ...
    listener() {
        ...
        this.addEventListeners(document, this.getModalOption("events"), (event) => {
            ...
            if (
                this.getModalOption("outsideClick") &&
                !this.hasSomeParentTheClass(event.target, this.getModalOption("modalDivClass"))
            ) {
                this.closeModal();
            }
